        ...
        <div class="container">
			...
			<section class="main">
				<form class="form-3" action="/AnyQuant_web/login.action">
				    ...
				    <p></p>
				    <p class="clearfix"> 
				     	<a class="orange button" href="${pageContext.request.contextPath}/askForRegister.action">注册</a>
				    </p>
				    
				    <p class="clearfix"> 
				     	<a class="orange button" href="${pageContext.request.contextPath}/">游客访问</a>
				    </p>
