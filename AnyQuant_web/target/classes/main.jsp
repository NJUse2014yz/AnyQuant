	...
	<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" >
		...
		<div id="fdw-pricing-table">
			<div class="plan plan1">
				...
				<a id='可口可乐' class="signup link1" onclick='requiryStock(this.id)'>查看更多</a>
			</div>
		...
		function requiryStock(id){
			...
			window.location.href="${pageContext.request.contextPath}/stockInfo.action?id="
					+id;
			alert(id);
		}
			...
			$.ajax({
				...
				success:function(data){
					$.each(data,function(i,stock){
						$(".plan"+i+" .header").text(stock.name);
					});
					$(".plan1 "+ ".header").text(name);
