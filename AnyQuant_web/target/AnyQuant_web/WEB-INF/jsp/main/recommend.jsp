...
<div class="recom-container">			
	<div class="wrapper">
		<ul id="sb-slider" class="sb-slider">
			<li>
				<a href="#" target="_blank"><img src="graphics/main/modelback1.jpg" alt="image1"/></a>
				<div class="sb-description">
					<h3>策略模块1</h3>
				</div>
			</li>
			<li>
				<a href="#" target="_blank"><img src="graphics/main/modelback2.jpg" alt="image2"/></a>
				<div class="sb-description">
					<h3>策略模块2</h3>
				</div>
			</li>
			<li>
				<a href="#" target="_blank"><img src="graphics/main/modelback3.jpg" alt="image1"/></a>
				<div class="sb-description">
					<h3>策略模块3</h3>
				</div>
			</li>
			<li>
				<a href="#" target="_blank"><img src="graphics/main/modelback4.jpg" alt="image1"/></a>
				<div class="sb-description">
					<h3>策略模块4</h3>
				</div>
			</li>
